...
public class PlagueWatcherHealth : MonoBehaviour {
	...
	private void Update() {
		v3_LocalScale.x = (go_Enemy.GetComponent<PlagueWatcher>().fEnemyHealth / go_Enemy.GetComponent<PlagueWatcher>().fEnemyMaxHealth) * 10f;
